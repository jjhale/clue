...
"""
Taking v2 and trying to make it work with ray
"""


def env(render_mode: Optional[str] = None) -> AECEnv:
    internal_render_mode = render_mode if render_mode != "ansi" else "human"
    env = ClueEnvironment(render_mode=internal_render_mode, max_episode_steps=24000)
...
class ClueEnvironment(AECEnv):
    ...
    def __init__(
        ...
        self.num_actions = 9 + 324 + 1 + 21  # (9+324+1+21 = 355 actions)
        self.action_spaces = {
